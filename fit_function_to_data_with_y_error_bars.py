...
def fit_it (func, data):
    ...
    chi, p_val = chisquare(DATA.y, func(data.x, *popt))
...
def plot_it(data, fit_param):
    ...
    plt.errorbar(data.x, data.y, xerr=data.dx, yerr=data.dy, fmt='none', label='experiment')
